  ...
  parts: [
    {
      ...
      metalness: 0.75,
      roughness: 0.2,
      hotspot: { points: "0.4867,0.1069 0.4711,0.1094 0.4600,0.1138 0.4433,0.1275 0.4389,0.1344 0.4400,0.1669 0.4456,0.1831 0.4500,0.1875 0.4733,0.1938 0.5033,0.1938 0.5244,0.1900 0.5322,0.1850 0.5433,0.1537 0.5444,0.1394 0.5378,0.1250 0.5256,0.1150 0.5078,0.1081" },
    },
    {
      id: "face-plate",
    ...
    },
    {
      ...
      metalness: 0.3,
      roughness: 0.4,
      hotspot: { points: "0.3956,0.2387 0.3900,0.2431 0.3767,0.2819 0.3867,0.3056 0.3956,0.3613 0.4278,0.3700 0.5322,0.3713 0.5578,0.3675 0.5778,0.3056 0.5889,0.2888 0.5789,0.2450 0.5744,0.2425 0.4833,0.2425" },
    },
    {
      id: "battery-pack",
      ...
      metalness: 0.7,
      roughness: 0.4,
      hotspot: { points: "0.3933,0.2394 0.3767,0.2875 0.3867,0.3050 0.3944,0.3600 0.4089,0.3663 0.4511,0.3706 0.5267,0.3713 0.5556,0.3675 0.5644,0.3569 0.5778,0.3056 0.5889,0.2888 0.5778,0.2437" },
    },
    {
      id: "cooling-vents",
    ...
    },
    {
      ...
      metalness: 0.4,
      roughness: 0.45,
      hotspot: { points: "0.0000,0.7594 0.0078,0.9994 0.9956,0.9994 0.9933,0.7625 0.8189,0.7631 0.8700,0.8256 0.8633,0.8806 0.7833,0.9287 0.7100,0.9444 0.1622,0.9375 0.0433,0.8744 0.0411,0.8225 0.0956,0.7606" },
    },
    // Shoulders
    {
      id: "shoulder-l",
    ...
    // Upper arms (slightly forward)
    {
      ...
      metalness: 0.5,
      roughness: 0.4,
      hotspot: { points: "0.3611,0.2406 0.3544,0.2400 0.3356,0.2419 0.3233,0.2469 0.3167,0.2525 0.3122,0.2631 0.3133,0.2988 0.3156,0.3006 0.3644,0.3031 0.3711,0.3025 0.3678,0.2900 0.3744,0.2456 0.3722,0.2437" },
    },
    {
      id: "upper-arm-r",
      ...
      metalness: 0.5,
      roughness: 0.4,
      hotspot: { points: "0.5967,0.2481 0.5956,0.2512 0.5978,0.2812 0.5922,0.3075 0.6478,0.3088 0.6522,0.3044 0.6578,0.2744 0.6567,0.2675 0.6478,0.2550 0.6333,0.2481 0.6156,0.2462" },
    },
    // Elbows
    {
      id: "elbow-l",
    ...
    // Forearms (house hand-tendon actuators)
    {
      ...
      metalness: 0.5,
      roughness: 0.4,
      hotspot: { points: "0.4356,0.2044 0.2733,0.2044 0.2756,0.4394 0.2811,0.4419 0.3033,0.4394 0.3100,0.4088 0.3089,0.2606 0.3144,0.2519 0.3378,0.2400 0.3733,0.2412 0.3789,0.2338 0.4256,0.2169" },
    },
    {
      id: "forearm-r",
      ...
      metalness: 0.5,
      roughness: 0.4,
      hotspot: { points: "0.6156,0.2456 0.5967,0.2494 0.5978,0.2869 0.5900,0.3094 0.5967,0.3563 0.5878,0.3900 0.6000,0.4625 0.6067,0.4669 0.6133,0.4631 0.6111,0.4550 0.6211,0.4519 0.6178,0.4625 0.6267,0.4631 0.6289,0.4481 0.6211,0.4512 0.6100,0.4481 0.6044,0.4150 0.6111,0.4094 0.6322,0.4125 0.6322,0.4381 0.6378,0.4344 0.6456,0.3856 0.6422,0.3513 0.6567,0.2800 0.6456,0.2550" },
    },
    // Hands (flat boxes)
    {
      id: "hand-l",
    ...
    // Thighs
    {
      ...
      metalness: 0.5,
      roughness: 0.4,
      hotspot: { points: "0.0000,0.7588 0.0056,0.9994 0.9956,0.9994 0.9933,0.7625 0.8189,0.7631 0.8711,0.8256 0.8633,0.8800 0.8011,0.9213 0.7089,0.9444 0.1567,0.9369 0.0422,0.8725 0.0400,0.8231 0.0956,0.7600" },
    },
    {
      id: "thigh-r",
      name: "Right Thigh",
      ...
      metalness: 0.5,
      roughness: 0.4,
      hotspot: { points: "0.5789,0.4713 0.5689,0.4994 0.5489,0.5050 0.5100,0.5081 0.5011,0.5206 0.5033,0.5544 0.5200,0.5988 0.5144,0.6031 0.5144,0.6194 0.5211,0.6262 0.5256,0.6544 0.5222,0.7163 0.5344,0.7219 0.5456,0.7019 0.5622,0.6100 0.5722,0.5913 0.5856,0.5300 0.5867,0.4844" },
    },
    // Knees
    {
      id: "knee-l",
