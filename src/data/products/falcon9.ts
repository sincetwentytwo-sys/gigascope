...
const parts: PartSpec[] = [
  ...
  },
  {
    ...
    metalness: 0.4,
    roughness: 0.5,
      hotspot: { points: "0.5646,0.4619 0.5579,0.4600 0.5497,0.4612 0.5325,0.4713 0.5138,0.4781 0.4862,0.4913 0.4757,0.4944 0.4690,0.5062 0.4653,0.5206 0.4735,0.5300 0.4780,0.5306 0.4817,0.5244 0.4996,0.5075 0.5452,0.4881 0.5639,0.4819 0.5668,0.4788 0.5676,0.4669" },
  },
  {
    id: "stage2-tank",
    name: "Stage 2 Tank",
