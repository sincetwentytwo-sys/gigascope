...
const parts: PartSpec[] = [
  ...
  },
  {
    ...
    metalness: 0.2,
    roughness: 0.6,
      hotspot: { points: "0.0030,0.0000 0.0000,0.5656 0.3532,0.4950 0.4048,0.4275 0.4115,0.2925 0.4302,0.4475 0.4780,0.4888 0.5713,0.4581 0.5422,0.3531 0.5945,0.0563 0.6117,0.7288 0.6550,0.5550 0.7087,0.5375 0.6833,0.7200 0.7207,0.7344 0.7319,0.6412 0.7901,0.6294 0.8043,0.7394 0.9948,0.8769 0.9978,0.0000" },
  },
  {
    id: "grid-fin-1",
  ...
  },
  {
    ...
    metalness: 0.4,
    roughness: 0.5,
      hotspot: { points: "0.0030,0.0000 0.0000,0.5656 0.3525,0.4956 0.4048,0.4269 0.4115,0.2925 0.4302,0.4475 0.4772,0.4881 0.5706,0.4556 0.5422,0.3531 0.5952,0.0563 0.6117,0.7288 0.6550,0.5556 0.7087,0.5375 0.6826,0.7188 0.7199,0.7344 0.7311,0.6419 0.7901,0.6294 0.8043,0.7394 0.9948,0.8769 0.9978,0.0000" },
  },
  {
    id: "stage2-tank",
    name: "Stage 2 Tank",
    ...
    metalness: 0.2,
    roughness: 0.6,
      hotspot: { points: "0.0030,0.0000 0.0000,0.5656 0.3525,0.4956 0.4048,0.4281 0.4137,0.2919 0.4302,0.4481 0.4780,0.4875 0.5706,0.4581 0.5422,0.3525 0.5945,0.0563 0.6109,0.7288 0.6550,0.5550 0.7155,0.5400 0.6819,0.7181 0.7199,0.7350 0.7311,0.6412 0.7901,0.6294 0.8036,0.7394 0.9955,0.8775 0.9978,0.0000" },
  },
  {
    id: "mvac",
  ...
  },
  {
    ...
    metalness: 0.2,
    roughness: 0.55,
      hotspot: { points: "0.0030,0.0000 0.0000,0.5650 0.3488,0.4981 0.4048,0.4275 0.4115,0.2925 0.4294,0.4469 0.4787,0.4875 0.5713,0.4562 0.5422,0.3525 0.5945,0.0563 0.6109,0.7288 0.6550,0.5550 0.7140,0.5394 0.6826,0.7194 0.7192,0.7362 0.7304,0.6425 0.7901,0.6294 0.8043,0.7400 0.9955,0.8775 0.9978,0.0000" },
  },
  {
    id: "fairing-half-2",
    name: "Payload Fairing (half -X)",
