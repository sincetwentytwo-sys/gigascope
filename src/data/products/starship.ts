...
const parts: PartSpec[] = [
  ...
  },
  {
    ...
    metalness: 0.5,
    roughness: 0.5,
      hotspot: { points: "0.0040,0.0000 0.0067,0.8194 0.0930,0.8175 0.1659,0.7350 0.2522,0.7156 0.2421,0.4994 0.2803,0.4706 0.3284,0.5531 0.3866,0.4387 0.3886,0.2106 0.3552,0.1694 0.3880,0.1550 0.3873,0.0881 0.4355,0.0844 0.4408,0.0156 0.4863,0.1556 0.5498,0.1181 0.5739,0.1531 0.6769,0.1631 0.5759,0.2263 0.6080,0.7238 0.8602,0.7444 0.9946,0.8425 0.9960,0.0000" },
  },
  // ===== Starship (ship) =====
  {
    id: "ship-rvac-1",
