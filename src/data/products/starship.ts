...
const parts: PartSpec[] = [
  ...raptor33(),
  {
    ...
    metalness: 0.85,
    roughness: 0.25,
      hotspot: { points: "0.0033,0.0000 0.0054,0.8219 0.1003,0.8181 0.1672,0.7350 0.2535,0.7175 0.2428,0.4975 0.2803,0.4706 0.3284,0.5550 0.3880,0.4387 0.3893,0.2125 0.3552,0.1694 0.3886,0.1544 0.3873,0.0881 0.4361,0.0844 0.4415,0.0163 0.4870,0.1562 0.5498,0.1181 0.5739,0.1531 0.6776,0.1650 0.5759,0.2275 0.6080,0.7269 0.8589,0.7444 0.9960,0.8450 0.9960,0.0000" },
  },
  {
    id: "booster-chines",
  ...
  },
  {
    ...
    metalness: 0.5,
    roughness: 0.5,
      hotspot: { points: "0.0027,0.0000 0.0054,0.8219 0.1010,0.8181 0.1679,0.7350 0.2535,0.7181 0.2428,0.5000 0.2789,0.4700 0.3284,0.5569 0.3873,0.4394 0.3893,0.2125 0.3552,0.1694 0.3886,0.1544 0.3880,0.0881 0.4361,0.0850 0.4408,0.0163 0.4870,0.1562 0.5492,0.1181 0.5739,0.1531 0.6769,0.1638 0.5759,0.2256 0.6080,0.7275 0.8569,0.7444 0.9953,0.8444 0.9967,0.0000" },
  },
  // ===== Starship (ship) =====
  {
    id: "ship-rvac-1",
  ...
  },
  {
    ...
    metalness: 0.85,
    roughness: 0.25,
      hotspot: { points: "0.0027,0.0000 0.0047,0.8225 0.1003,0.8187 0.1686,0.7350 0.2555,0.7163 0.2428,0.4994 0.2776,0.4700 0.3284,0.5550 0.3886,0.4387 0.3893,0.2131 0.3552,0.1694 0.3880,0.1562 0.3880,0.0881 0.4361,0.0856 0.4415,0.0163 0.4870,0.1562 0.5492,0.1181 0.5732,0.1531 0.6769,0.1631 0.5759,0.2263 0.6067,0.7250 0.8569,0.7444 0.9967,0.8462 0.9967,0.0000" },
  },
  {
    id: "ship-tiles",
