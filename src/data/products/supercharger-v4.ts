...
export const superchargerV4: ProductSpec = {
  ...
  parts: [
    ...
    },
    {
      ...
      metalness: 0.3,
      roughness: 0.3,
      hotspot: { points: "0.2780,0.0661 0.2898,0.7549 0.3216,0.8078 0.3687,0.8439 0.4417,0.8677 0.5218,0.8686 0.5842,0.8519 0.6360,0.8192 0.6879,0.7046 0.6949,0.0714 0.5524,0.0511" },
    },
    {
      id: "rfid",
      name: "RFID Tap Zone",
